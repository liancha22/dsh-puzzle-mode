...
const OPS = ['list', 'read', 'show', 'init', 'main', 'module', 'health', 'mode']
  ...
  ctx.tools.register(defineTool({
    ...
    parameters: {
      op: {
        type: 'string',
        required: true,
        description: 'list 列项目 / read 读状态 / show 读模块详情 / init 新建项目 / main 主文档小节 / module 模块文档小节 / health 写五维健康性 / mode 切换模式',
        enum: OPS,
      },
